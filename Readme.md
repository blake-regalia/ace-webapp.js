...
Useful when creating static sites with browserify.

```js
npm i --save-dev ace-webapp
```

Then, from one of your site's scripts (with es2015):
```js
import 'ace-webapp'; // `ace` will now be loaded into the global `window` object
```
